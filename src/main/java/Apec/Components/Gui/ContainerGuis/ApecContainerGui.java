...
/**
 * Copy of net.minecraft.client.gui.inventory.GuiContainer but with all the private fields set to public
 */
public abstract class ApecContainerGui extends GuiScreen
{
    ...
    public boolean shouldDrawItems = true;
    public boolean shouldAllowSlotClickLogic = true;

    public void disableItemRendering() {
        shouldDrawItems = false;
    }

    public void disableSlotClickLogic() {
        shouldAllowSlotClickLogic = false;
    }

    public ApecContainerGui(Container inventorySlotsIn)
    {
